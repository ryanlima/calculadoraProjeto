angular.module('app.controllers', [])
  ...
  //  USAR TECLADO COMPLETO COM ESSA FUNÇÃO // // // //
  // $scope.numbers = function (x) {memory.push(x);  //
  //    $scope.decimal = memory.join('') * 1;//      //
  // }                                               //
  // // // // // // // // // // // // // // // // // //    
 
/*    USANDO TECLADO SE USAR A OPCAO CLIKAR NO INPUT 
    $scope.test = function() {
      $scope.decimal="";
      $scope.zero = function() {$scope.decimal+="0";};
      $scope.one = function()  {$scope.decimal+="1";};
    ...
    $scope.test1 = function() {
      $scope.binario="";
      $scope.one = function() {$scope.binario+="1";};
      $scope.zero = function() {$scope.binario+="0";};
